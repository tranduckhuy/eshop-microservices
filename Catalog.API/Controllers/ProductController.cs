...
namespace Catalog.API.Controllers
{
    public class ProductController : BaseController
    {
        ...
        public async Task<IActionResult> GetProductsByBrandName(string brandName)
        {
            ...
            return await ExecuteAsync<GetProductByBrandNameQuery, IEnumerable<ProductResponse>>(query);
        }

        [HttpGet]
        [Route("[action]/{categoryName}", Name = "GetProductsByCategoryName")]
        public async Task<IActionResult> GetProductsByCategoryName(string categoryName)
        {
            ...
            return await ExecuteAsync<GetProductByCategoryQuery, IEnumerable<ProductResponse>>(query);
        }
